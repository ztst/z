<?
    ...
    class Vimeo
    {
         ...
         *
         * @internal param string $callback_url The URL to redirect the user back to, or oob for the default.
         *
        ...
        public static function url_encode_rfc3986($input)
        {
            if (is_array($input))
            {
                return array_map(array('Znaika\FrontendBundle\Helper\Vimeo', 'url_encode_rfc3986'), $input);
            }
            else
            {
                if (is_scalar($input))
