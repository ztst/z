...
/// sphinx searchd client class
    class SphinxClient
    {
        ...
        function SetQueryFlag($flag_name, $flag_value)
        {
            ...
            assert(in_array($flag_value, $flags[$flag_name],
                true) || ($flag_name == "max_predicted_time" && is_int($flag_value) && $flag_value >= 0));
            ...
            {
                $this->_query_flags = sphSetBit($this->_query_flags, 1,
                    $flag_value == "kbuffer");
            }
